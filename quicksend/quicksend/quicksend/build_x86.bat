...
"%PYTHON_X86%" -m pip install flask pyinstaller>=6.0 werkzeug pywebview pillow pystray jaraco.text certifi
...
echo.
echo Success! x86 Installer created at: ..\..\installer\QuickSend-Setup-1.0.15-win32.exe
rem pause
